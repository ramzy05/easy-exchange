...
class Account(AbstractBaseUser):
    ...
    balance = models.DecimalField(verbose_name=_('balance'), default=5000, max_digits=15, decimal_places=2)
    date_joined = models.DateTimeField(verbose_name=("date_joined"),auto_now_add=True)
    last_login = models.DateTimeField(verbose_name=_('last login'), blank=True, null=True, auto_now=True)
...
#     receiver = models.ForeignKey(User, related_name='receiver', on_delete=models.SET_NULL, null=True, blank=True)
